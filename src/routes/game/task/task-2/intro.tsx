...
export default function TaskIntro({ onComplete }: Props) {
    ...
    return <>
        ...
        >
            ...
            <p>
                Ta furtka prowadzi donikąd, za nią nie ma domu ani ogrodu. Stoi samotnie przy ulicy, a za nią jest tylko las. Napis na portalu mimo upływu lat wciąż jest czytelny. Przeczytajcie go i przejdźcie do lasu.<br />

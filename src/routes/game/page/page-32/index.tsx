...
export default function Page1({ onNext }: Props) {
    return <TextPage>
        ...
        <img className='page-img' src={slonimski} alt="" />
            ...
            <p> Ani się obejrzysz, a połówka zrobiona. Masz zadatki na dobrego literata. Albo na solidną literatkę, ma się rozumieć. Masz już trzy z pięciu znaków szyfru.

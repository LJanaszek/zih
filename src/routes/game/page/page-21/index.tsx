...
export default function Page1({ onNext }: Props) {
    ...
    return <TextPage>
        ...
        <p className={style.pPopup}>Haskala, nazywana również oświeceniem żydowskim, to ruch intelektualny Żydów europejskich, którego początki datuje się na późne lata XVIII wieku, opowiadający się za przyjęciem przez nich oświeceniowych ideałów. Haskala stanowiła złożone zjawisko kulturowe i intelektualne, rozwijające się również w społeczności żydowskiej XIX-wiecznej rozbiorowej Polski. Głównym celem tego ruchu było wprowadzenie modernizacji, edukacji i procesu akulturacji wśród Żydów.
</p>

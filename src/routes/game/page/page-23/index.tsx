...
export default function Page1({ onNext }: Props) {
    return <TextPage>
        ...
        <img className='page-img' src={slonimski} alt="" />
            ...
            <p>Litery hebrajskiego alfabetu mają fantazyjne kształty. Ale i nasz alfabet to nie w kij dmuchał. Albo nie w “I” dmuchał. Chcesz drugą literę szyfru? To spójrz na litery inaczej niż zwykle. 

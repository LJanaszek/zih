...
export default function Page1({ onNext }: Props) {
    ...
    return <TextPage>
        ...
        <p className={style.pPopup}>W XIX wieku społeczności żydowskie o charakterze tradycyjnym przejawiały zróżnicowane stanowiska wobec kwestii integracji. Grupy ortodoksyjne, wyraźnie osadzone w tradycji religijnej, często przyjmowały stanowisko nieufności lub wręcz sprzeciwu wobec idei integracji społecznej. 
</p>

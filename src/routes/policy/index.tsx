    ...
    return <>
        ...
        <TextPage>
            <Box>
                ...
                <p>
                    Wawerskie Centrum Kultury z siedzibą w Warszawie przy ulicy Żegańskiej 1a, jako właściciel i Administrator serwisu: <a href="https://gra-z-schulzem.wck-wawer.pl">https://gra-z-schulzem.wck-wawer.pl/</a> (dalej: Serwis) przedstawia poniżej informacje dotyczące zastosowania i wykorzystania w Serwisie plików cookie.
                </p>
                ...
                <p>
                    Serwis zewnętrzny zapewniający usługi analityczne: Google LLC, ma własną politykę cookies <a href="https://policies.google.com/technologies/cookies">(https://policies.google.com/technologies/cookies)</a> (https://policies.google.com/technologies/cookies). Może dodać dane zebrane podczas Twojej wizyty do zbioru danych pozyskanych na Twój temat z innych źródeł.
                </p>
                <p>
